  ...
  return (
    ...
    <div className="register-container absolute z-50 inset-0 flex items-center justify-center min-h-screen">
      <div className="register-form w-full max-w-md p-8 bg-white rounded-2xl shadow-lg">
        <h1 className="text-3xl font-bold mb-6 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-700 to-pink-400 ">Register</h1>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-52 py-3 bg-gradient-to-l from-purple-700 to-pink-400 font-semibold text-white rounded-full hover:scale-110">
            Register
          </button>
          </div>
